...
PyGOD's
[GAE](https://docs.pygod.org/en/latest/generated/pygod.detector.GAE.html#pygod.detector.GAE)
detector. Graph Autoencoder.
...
Declared by no other bond method: `_RECON_S`.
