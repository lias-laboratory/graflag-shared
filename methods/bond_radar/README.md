...
PyGOD's
[RADAR](https://docs.pygod.org/en/latest/generated/pygod.detector.Radar.html#pygod.detector.Radar)
detector. Residual Analysis for Anomaly Detection in Attributed Networks.
...
Its parameter set is identical to `bond_anomalous`'s: no backbone, no
batching, no layer count. Both are matrix-factorisation detectors rather than
neural ones.
