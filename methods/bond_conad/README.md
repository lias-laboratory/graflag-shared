...
PyGOD's
[CONAD](https://docs.pygod.org/en/latest/generated/pygod.detector.CONAD.html#pygod.detector.CONAD)
detector. Contrastive Attributed Network Anomaly Detection.
...
Declared by no other bond method: `_MARGIN`, `_R`, `_M`, `_F`.
